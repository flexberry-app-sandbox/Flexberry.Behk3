...
namespace IIS.Behk3
{
    ...
    public class ДокументЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk3.Контрагенты fКонтрагенты;
        
        private IIS.Behk3.DetailArrayOfЗапись fЗапись;
        ...
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        [NotNull()]
        public virtual IIS.Behk3.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.Behk3.Контрагенты result = this.fКонтрагенты;
        ...
        public virtual IIS.Behk3.DetailArrayOfЗапись Запись
        {
            get
            {
                ...
                {
                    this.fЗапись = new IIS.Behk3.DetailArrayOfЗапись(this);
                }
                IIS.Behk3.DetailArrayOfЗапись result = this.fЗапись;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументЗаказаE", typeof(IIS.Behk3.ДокументЗаказа));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокументЗаказаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументЗаказаL", typeof(IIS.Behk3.ДокументЗаказа));
                }
            }
        }
    }
