...
namespace IIS.Behk3
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk3.Полы fПол;
        
        private System.DateTime fДатаРождения;
        
        private IIS.Behk3.Должности fДолжности;
        ...
        public virtual IIS.Behk3.Полы Пол
        {
            get
            {
                ...
                IIS.Behk3.Полы result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Behk3.Должности Должности
        {
            get
            {
                ...
                IIS.Behk3.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Behk3.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Behk3.Сотрудники));
                }
            }
        }
    }
