...
namespace IIS.Behk3
{
    ...
    public class Питания : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk3.Питание fВидПитания;
        
        private IIS.Behk3.DetailArrayOfСоставБлюда fСоставБлюда;
        ...
        public virtual IIS.Behk3.Питание ВидПитания
        {
            get
            {
                ...
                IIS.Behk3.Питание result = this.fВидПитания;
        ...
        public virtual IIS.Behk3.DetailArrayOfСоставБлюда СоставБлюда
        {
            get
            {
                ...
                {
                    this.fСоставБлюда = new IIS.Behk3.DetailArrayOfСоставБлюда(this);
                }
                IIS.Behk3.DetailArrayOfСоставБлюда result = this.fСоставБлюда;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПитанияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПитанияE", typeof(IIS.Behk3.Питания));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПитанияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПитанияL", typeof(IIS.Behk3.Питания));
                }
            }
        }
    }
