...
namespace IIS.Behk3
{
    ...
    [View("ЗаписьE", new string[] {
            ...
            "Питания as \'Питания\'",
            "Питания.КодПитания as \'Код питания\'"}, Hidden=new string[] {
            "Сотрудники.Фамилия",
            "Питания.КодПитания"})]
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Behk3.Сотрудники fСотрудники;
        
        private IIS.Behk3.Питания fПитания;
        
        private IIS.Behk3.ДокументЗаказа fДокументЗаказа;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Behk3.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Behk3.Сотрудники result = this.fСотрудники;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Behk3.ДокументЗаказа.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ДокументЗаказа"})]
        public virtual IIS.Behk3.ДокументЗаказа ДокументЗаказа
        {
            get
            {
                ...
                IIS.Behk3.ДокументЗаказа result = this.fДокументЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Behk3.Запись));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗапись : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Behk3.DetailArrayOfЗапись members)

        // *** End programmer edit section *** (IIS.Behk3.DetailArrayOfЗапись members)
        ...
        /// </summary>
        public DetailArrayOfЗапись(IIS.Behk3.ДокументЗаказа fДокументЗаказа) : 
                base(typeof(Запись), ((ICSSoft.STORMNET.DataObject)(fДокументЗаказа)))
        {
        }
        
        public IIS.Behk3.Запись this[int index]
        {
            get
            {
                return ((IIS.Behk3.Запись)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Behk3.Запись dataobject)
        {
